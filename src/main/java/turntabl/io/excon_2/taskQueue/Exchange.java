package turntabl.io.excon_2.taskQueue;


import org.springframework.web.reactive.function.client.WebClient;
import redis.clients.jedis.Jedis;
import turntabl.io.excon_2.Utility;
import turntabl.io.excon_2.module.OrderBookRequest;
import turntabl.io.excon_2.module.PendingOrder;
...
public class Exchange implements Runnable {
    ...
    public void run() {
        while (true){
            String data = jedis.rpop("exchange2-orderrequest");
...
//					Arrays.stream(pendingOrders).forEach(pendingOrder -> pendingOrder.setExchange("exchange1"));
            ...
            for (PendingOrder pendingOrder : pendingOrders) {
                pendingOrder.setExchange("exchange2");
            }
